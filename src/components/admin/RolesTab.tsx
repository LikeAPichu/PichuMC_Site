...
const ALL_PERMISSIONS = [
  ...
  { key: "auth_view", label: "Auth Bekijken", desc: "Kan de Discord login & koppelingsinstellingen bekijken." },
  { key: "auth_manage", label: "Auth Beheren", desc: "Kan Discord OAuth credentials, knoppen, role-mappings en de 'koppelen vereist' toggle aanpassen." },
